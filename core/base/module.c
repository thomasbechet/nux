...
nux_status_t
nux_base_start (const nux_c8_t *module)
{
    // TODO init module and init dependency chain
    return NUX_SUCCESS;
}
void
nux_base_update (void)
{
    // TODO update systems per phase
}
void
nux_base_on_event (nux_os_event_t *event)
{
}

...
static int l_core_time(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
        nux_f32_t ret =
    nux_time(ctx);
...
static int l_core_dt(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
        nux_f32_t ret =
    nux_dt(ctx);
...
static int l_core_frame(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
        nux_u32_t ret =
    nux_frame(ctx);
...
static int l_core_random(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
        nux_u32_t ret =
    nux_random(ctx);
...
static int l_input_button(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
...
static int l_input_axis(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
        ...
        nux_f32_t ret =
    nux_input_axis(ctx, player, axis);
    l_checkerror(L, ctx);
        lua_pushnumber(L, ret);
        return 1;
}
...
static int l_button_pressed(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
        ...
        nux_b32_t ret =
    nux_button_pressed(ctx, player, button);
    l_checkerror(L, ctx);
        lua_pushboolean(L, ret);
        return 1;
}
static int l_button_released(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
            nux_u32_t player = luaL_checkinteger(L, 1);
        ...
        nux_b32_t ret =
    nux_button_released(ctx, player, button);
    l_checkerror(L, ctx);
        lua_pushboolean(L, ret);
        return 1;
}
static int l_button_just_pressed(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
        ...
        nux_b32_t ret =
    nux_button_just_pressed(ctx, player, button);
    l_checkerror(L, ctx);
        lua_pushboolean(L, ret);
        return 1;
}
static int l_button_just_released(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
            nux_u32_t player = luaL_checkinteger(L, 1);
        ...
        nux_b32_t ret =
    nux_button_just_released(ctx, player, button);
    l_checkerror(L, ctx);
        lua_pushboolean(L, ret);
        return 1;
}
...
static int l_arena_new(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
...
static int l_arena_reset(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
...
static int l_arena_frame(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
        nux_res_t ret =
    nux_arena_frame(ctx);
...
static int l_arena_scratch(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
        nux_res_t ret =
    nux_arena_scratch(ctx);
    l_checkerror(L, ctx);
        if (ret)
            lua_pushnumber(L, (nux_intptr_t)ret);
        else
...
static int l_io_cart_begin(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
...
static int l_io_cart_end(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
        nux_status_t ret =
    nux_io_cart_end(ctx);
...
static int l_io_write_cart_file(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
            const nux_c8_t *path = luaL_checkstring(L, 1);
...
{ "stat", l_core_stat },{ "time", l_core_time },{ "dt", l_core_dt },{ "frame", l_core_frame },{ "random", l_core_random },{ NUX_NULL, NUX_NULL }
};

static const struct luaL_Reg lib_input[] = {
{ "button", l_input_button },{ "axis", l_input_axis },{ NUX_NULL, NUX_NULL }
};

static const struct luaL_Reg lib_button[] = {
{ "pressed", l_button_pressed },{ "released", l_button_released },{ "just_pressed", l_button_just_pressed },{ "just_released", l_button_just_released },{ NUX_NULL, NUX_NULL }
};

static const struct luaL_Reg lib_arena[] = {
{ "new", l_arena_new },{ "reset", l_arena_reset },{ "frame", l_arena_frame },{ "scratch", l_arena_scratch },{ NUX_NULL, NUX_NULL }
};

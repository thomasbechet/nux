...
static int l_core_pal(lua_State *L)
{
...
static int l_core_palt(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
...
static int l_core_palr(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);nux_palr(ctx);
    l_checkerror(L, ctx);
        return 0;
}
static int l_core_palc(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
            nux_u8_t index = luaL_checkinteger(L, 1);
...
static int l_core_cls(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
...
static int l_core_pset(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
...
static int l_core_cget(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
            nux_u8_t index = luaL_checkinteger(L, 1);
...
static int l_core_cset(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
            nux_u8_t index = luaL_checkinteger(L, 1);
...
static int l_texture_blit(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
...
static int l_mesh_new_cube(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
            nux_res_t arena = (nux_res_t)(nux_intptr_t)luaL_checknumber(L, 1);
...
static int l_mesh_gen_bounds(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
...
static int l_canvas_render(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
            nux_res_t res = (nux_res_t)(nux_intptr_t)luaL_checknumber(L, 1);
...
static int l_canvas_rectangle(lua_State *L)
{
    nux_ctx_t *ctx = lua_getuserdata(L);
            nux_res_t res = (nux_res_t)(nux_intptr_t)luaL_checknumber(L, 1);
...
{ "pal", l_core_pal },{ "palt", l_core_palt },{ "palr", l_core_palr },{ "palc", l_core_palc },{ "cls", l_core_cls },{ "pset", l_core_pset },{ "cget", l_core_cget },{ "cset", l_core_cset },{ NUX_NULL, NUX_NULL }
};
...
{ "new", l_mesh_new },{ "new_cube", l_mesh_new_cube },{ "gen_bounds", l_mesh_gen_bounds },{ NUX_NULL, NUX_NULL }
};

static const struct luaL_Reg lib_canvas[] = {
{ "new", l_canvas_new },{ "clear", l_canvas_clear },{ "render", l_canvas_render },{ "text", l_canvas_text },{ "rectangle", l_canvas_rectangle },{ NUX_NULL, NUX_NULL }
};

...
void      nux_camera_set_fov(nux_node_t *node, nux_f32_t fov);
void      nux_camera_set_near(nux_node_t *node, nux_f32_t near);
void      nux_camera_set_far(nux_node_t *node, nux_f32_t far);
void      nux_camera_set_aspect(nux_node_t *node, nux_f32_t aspect);
void      nux_camera_set_ortho(nux_node_t *node, nux_b32_t ortho);
void      nux_camera_set_ortho_size(nux_node_t *node, nux_v2_t size);
nux_m4_t  nux_camera_projection(nux_node_t *node);
nux_v3_t  nux_camera_unproject(nux_node_t *node, nux_v2_t pos);
void      nux_camera_set_render_mask(nux_node_t *node, nux_u32_t mask);
nux_u32_t nux_camera_render_mask(nux_node_t *node);
void      nux_camera_set_viewport(nux_node_t *node, nux_b2i_t viewport);
nux_b2i_t nux_camera_viewport(nux_node_t *node);
void      nux_camera_set_target(nux_node_t *node, nux_id_t target);
nux_id_t  nux_camera_target(nux_node_t *node);
void      nux_camera_set_layer(nux_node_t *node, nux_i32_t layer);
nux_i32_t nux_camera_layer(nux_node_t *node);
void      nux_camera_set_clear_depth(nux_node_t *node, nux_b32_t clear_depth);
nux_b32_t nux_camera_clear_depth(nux_node_t *node);
void      nux_camera_set_auto_resize(nux_node_t *node, nux_b32_t auto_resize);
nux_b32_t nux_camera_auto_resize(nux_node_t *node, nux_b32_t auto_resize);
nux_v2_t  nux_camera_to_global(nux_node_t *node, nux_v2_t coord);
nux_v2_t  nux_camera_to_local(nux_node_t *node, nux_v2_t coord);

void        nux_staticmesh_set_mesh(nux_node_t *node, nux_mesh_t *mesh);
nux_mesh_t *nux_staticmesh_mesh(nux_node_t *node);
void nux_staticmesh_set_texture(nux_node_t *node, nux_texture_t *texture);
nux_texture_t *nux_staticmesh_texture(nux_node_t *node);
void nux_staticmesh_set_colormap(nux_node_t *node, nux_texture_t *colormap);
void nux_staticmesh_set_render_layer(nux_node_t *node, nux_u32_t layer);
nux_u32_t nux_staticmesh_render_layer(nux_node_t *node);
void      nux_staticmesh_set_draw_bounds(nux_node_t *node, nux_b32_t draw);

...
typedef enum
{
    ...
    NUX_OBJECT_TRANSFORM  = 16,
    NUX_OBJECT_CAMERA     = 17,
    NUX_OBJECT_STATICMESH = 18,
    NUX_OBJECT_RIGIDBODY  = 19,
    NUX_OBJECT_COLLIDER   = 20,
...
nux_object_type_t *nux_object_type(nux_u32_t type);

...
#define NUX_V2_IMPL(name, type, opadd, opsub, opmul, opdiv)             \
...
#define NUX_V3_IMPL(name, type, opadd, opsub, opmul, opdiv)                   \
...
NUX_V2_IMPL(v2i, nux_i32_t, NATIVE_ADD, NATIVE_SUB, NATIVE_MUL, NATIVE_DIV);
NUX_V2_IMPL(v2u, nux_u32_t, NATIVE_ADD, NATIVE_SUB, NATIVE_MUL, NATIVE_DIV);
NUX_V2_IMPL(v2, nux_f32_t, NATIVE_ADD, NATIVE_SUB, NATIVE_MUL, NATIVE_DIV);
NUX_V3_IMPL(v3i, nux_i32_t, NATIVE_ADD, NATIVE_SUB, NATIVE_MUL, NATIVE_DIV);
NUX_V3_IMPL(v3u, nux_u32_t, NATIVE_ADD, NATIVE_SUB, NATIVE_MUL, NATIVE_DIV);
NUX_V3_IMPL(v3, nux_f32_t, NATIVE_ADD, NATIVE_SUB, NATIVE_MUL, NATIVE_DIV);

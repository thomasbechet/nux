...
typedef enum
{
    ...
    NUX_GPU_DESC_UBER_TRANSFORMS      = 1,
    NUX_GPU_DESC_UBER_VERTICES        = 2,
    NUX_GPU_DESC_UBER_TEXTURE0        = 3,
    NUX_GPU_DESC_UBER_TRANSFORM_INDEX = 4,
    NUX_GPU_DESC_UBER_FIRST_VERTEX    = 5,
    NUX_GPU_DESC_UBER_HAS_TEXTURE     = 6,

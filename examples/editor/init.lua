...
function M:on_load()
    ...
    -- inputmap.bind_key(map, "viewx+", key.H)
    -- inputmap.bind_key(map, "viewx-", key.L)
    -- inputmap.bind_key(map, "viewy+", key.J)
    -- inputmap.bind_key(map, "viewy-", key.K)
    inputmap.bind_key(map, "click", key.E)
    inputmap.bind_mouse_button(map, "test", mouse.BUTTON_LEFT)
    inputmap.bind_mouse_axis(map, "viewx+", mouse.Y_POS, 0.01)
    inputmap.bind_mouse_axis(map, "viewx-", mouse.Y_NEG, 0.01)
    inputmap.bind_mouse_axis(map, "viewy+", mouse.X_POS, 0.01)
    inputmap.bind_mouse_axis(map, "viewy-", mouse.X_NEG, 0.01)
    input.set_map(0, map)

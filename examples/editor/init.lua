...
function M:on_load()
    ...
    inputmap.bind_mouse_axis(map, "view_right", mouse.X_RIGHT, 0.02)
    inputmap.bind_mouse_axis(map, "view_left", mouse.X_LEFT, 0.02)
    inputmap.bind_mouse_axis(map, "view_up", mouse.Y_UP, 0.02)
    inputmap.bind_mouse_axis(map, "view_down", mouse.Y_DOWN, 0.02)

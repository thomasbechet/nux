...
function M:on_load()
    ...
    inputmap.bind_mouse_axis(map, "viewx-", mouse.X_POS, 0.02)
    inputmap.bind_mouse_axis(map, "viewx+", mouse.X_NEG, 0.02)
    inputmap.bind_mouse_axis(map, "viewy+", mouse.Y_POS, 0.02)
    inputmap.bind_mouse_axis(map, "viewy-", mouse.Y_NEG, 0.02)
    input.set_map(0, map)
